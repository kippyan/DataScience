...
```{R}
dailyweatheryear = subset(dailyweather, format.Date(date, "%Y") =="2001" )
ggplot(dailyweatheryear, aes(as.numeric(format(dailyweatheryear$date, "%m")), temperature)) + geom_point() + labs(x = "month")
```
